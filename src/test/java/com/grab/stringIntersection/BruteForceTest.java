...
public class BruteForceTest {
   ...
   public StringIntersection stringIntersection = new StringIntersection();;
    ...
    public void withSomeCommonDuplicateWords(){
        ...
        ArrayList<String> actualResult = stringIntersection.getCommonWord2(arrayList1, arrayList2);
